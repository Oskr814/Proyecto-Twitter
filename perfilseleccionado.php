...
<body>
      ...
      <section class="seccion3">    
        <div class="contenedor1">
            <div><h5><b>'.$_SESSION["nombreUsuarioSeleccionado"].'</b></h5></div>   
             <div><p style="font-size:13px; color:#657786">@'.$_SESSION["usuarioSeleccionado"].'</p></div> 
            <div><p style="font-size:13px; color:#657786">Se unió en 2018-25-08 </p></div>
        </div>  
      ...
      <script src="js/controlador-perfil-seleccionado.js"></script>
