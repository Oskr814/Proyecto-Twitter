...
<head>
    ...
    <link rel="stylesheet" href="css/custom-terminos de servicio.css">
    <title>Twitter Términos de servicios</title>
</head>
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="home.php"><img src="img/img1.png"> Twitter Términos de servicio</a>
      ...
      <h1 class="portada">Twitter Términos de servicio</h1>
      
      <div class="container">
          <div class="row">
              <div class="col-lg-2">
                  <div><a href="#">1. Quién puede hacer uso de los Servicios</a></div>
                  <div><a href="#">2. Privacidad</a></div>
                  <div><a href="#">3. Contenido de los Servicios</a></div>
                  <div><a href="#">4. Uso de los Servicios</a></div>
                  <div><a href="#">5. Limitaciones de responsabilidad</a></div>
                  <div><a href="#">6. General</a></div>
              </div>
             <div class="col-lg-7">
                <p>
                    El Acuerdo de usuario de Twitter se compone de estos Términos de servicio, de nuestra Política de privacidad, de las Reglas de Twitter y de todas las políticas incorporadas a los mismos, si reside en la Unión Europea o fuera de los Estados Unidos.<br><br>
        
                    Si reside en Estados Unidos, el Acuerdo de usuario de Twitter se compone de estos Términos de servicio, de nuestra Política de privacidad, de las Reglas de Twitter y de todas las políticas incorporadas a estos.
                </p>
                
                 <h2>Twitter Términos de servicio</h2>
                 <h2>si reside fuera de Estados Unidos</h2>
                 <p>El Acuerdo de usuario de Twitter se compone de estos Términos de servicio, de nuestra Política de privacidad, de las Reglas de Twitter y de todas las           políticas incorporadas a los mismos, si reside en la Unión Europea o fuera de los Estados Unidos.
                    Si reside en Estados Unidos, el Acuerdo de usuario de Twitter se compone de estos Términos de servicio, de nuestra Política de privacidad, de las Reglas de Twitter y de todas las políticas incorporadas a estos.
                </p>
                <h1>1. Quién puede hacer uso de los Servicios</h1>
                <p>
                ...
                <h2>2. Privacidad</h2>
                <p>
                    Nuestra Política de privacidad (https://www.twitter.com/privacy) describe cómo manejamos la información que nos proporciona al hacer uso de nuestros Servicios. Comprende que mediante el uso que usted hace de nuestros Servicios, usted consiente a la recopilación y uso (tal y como se recoge en la Política de privacidad) de esta información, incluida su transferencia a los Estados Unidos, Irlanda y/o a otros países para su almacenamiento, procesamiento y uso por parte de Twitter y sus filiales.
                </p>
                <h2>3. Contenido de los Servicios</h2>
                <p>
                    Usted es responsable de su uso de Los Servicios y de cualquier Contenido que proporcione, incluyendo el cumplimiento con las leyes, reglas y normas aplicables. Solo debe proporcionarnos contenido que desee compartir con otros.<br>
                    ...
                    Nos reservamos el derecho a retirar Contenido que incumpla el Acuerdo de usuario, como por ejemplo, violaciones de derechos de autor o de marcas comerciales, suplantación de identidad, conducta ilícita o acoso. Encontrará a información relativa a políticas específicas y al proceso para notificar o impugnar incumplimientos en nuestro Centro de ayuda (https://support.twitter.com/articles/15789#specific-violations y https://support.twitter.com/articles/15790).<br><br>
                    
                    Si cree que su Contenido ha sido copiado de forma que constituya una infracción de los derechos de autor, notifíquenoslo visitando nuestro Formulario de notificación de infracción de derechos de autor (https://support.twitter.com/forms/dmca) o poniéndose en contacto con nuestro agente de derechos de autor en la dirección siguiente:<br><br>
                    
                    Attn: Agente de derechos de autor<br>
                    1355 Market Street, Suite 900<br>
                    San Francisco, CA 94103<br>
                    Notificaciones: https://support.twitter.com/forms/dmca<br>
                    Correo electrónico: copyright@twitter.com<br>
                    (para contenidos en Twitter)<br><br>
                ...
                <h2>Su licencia para el uso de los Servicios</h2>
                <p>
                    Twitter le otorga una licencia personal, mundial, libre de pago de derechos, no asignable y no exclusiva para usar el software que se le proporciona como parte de los Servicios. Esta licencia tiene como único fin permitirle usar y disfrutar del beneficio de los Servicios proporcionados por Twitter, de la forma autorizada en estos Términos.<br><br>

                    Los Servicios están protegidos por derechos de autor, marca comercial y por otras leyes tanto en los Estados Unidos como en países extranjeros. Nada en estos Términos le otorga el derecho de usar el nombre de Twitter o cualquiera de las marcas comerciales, logotipos, nombres de dominio u otras características distintivas de la marca. Todo derecho, título e interés en y de los Servicios (excluyendo el Contenido proporcionado por los usuarios) es y seguirá siendo propiedad exclusiva de Twitter y sus licenciatarios. Cualquier opinión, comentario o sugerencia que pueda proporcionar respecto a Twitter o a los Servicios, es totalmente voluntario y seremos libre de emplear dicha opinión, comentario o sugerencia como nos parezca sin obligación alguna para con usted.
                </p>
                <h2>Cancelación de estos Términos</h2>
                <p>
                    Puede cancelar su acuerdo legal con Twitter en cualquier momento desactivando sus cuentas e interrumpiendo el uso de los Servicios. Consulte https://support.twitter.com/articles/15358-how-to-deactivate-your-account (en el caso de Periscope consulte: https://help.pscp.tv/customer/portal/articles/2460220) para ver las instrucciones sobre cómo desactivar su cuenta y la Política de privacidad para más información sobre lo que ocurre con su información.<br><br>

                    Podremos suspender o cesar a su cuenta, o bien dejar de suministrarle todos o parte de los Servicios, en cualquier momento y por cualquier motivo, o sin motivo, como por ejemplo, si estimamos, dentro de lo razonable: (i) que usted ha incumplido estos Términos o las Reglas de Twitter o las Pautas de la Comunidad Periscope, (ii) que usted nos provoca un riesgo o una posible responsabilidad legal; (iii) que su cuenta debe ser eliminada debido a una conducta ilícita; o (iv) que su cuenta debe ser eliminada debido a su inactividad prolongada; o (v) que suministrarle los Servicios ya no resulta viable comercialmente. Realizaremos los esfuerzos razonables para notificarle a través de la dirección de correo electrónico asociada a su cuenta o la próxima vez que intente acceder a dicha cuenta, dependiendo de las circunstancias. En todos esos casos, los Términos serán cancelados, incluyendo, entre otros, su licencia para usar los Servicios, excepto las siguientes secciones que continuarán siendo de aplicación: II, III, V y VI.  Si considera que su cuenta ha sido cesada por error puede presentar una apelación siguiendo los pasos que puede consultar en nuestro Centro de ayuda (https://support.twitter.com/forms/general?subtopic=suspended).<br><br>
                </p>
                <h2>5. Limitaciones de responsabilidad</h2>
                <p>
                    Al hacer uso de los Servicios usted acepta que la responsabilidad de Twitter, así como de sus empresas matriz, filiales, sociedades relacionadas, responsables, directivos, empleados, agentes, representantes, socios y licenciatarios, estará limitada a la máxima medida permitida en su país de residencia. 
                </p>
                <h2>6. General</h2>
                <p>
                    Puede que revisemos estos Términos de vez en cuando. Los cambios no tendrán efecto retroactivo y la versión más actual de los Términos, que siempre se encontrará en twitter.com/tos, regirá nuestra relación con usted. Al margen de cambios dirigidos a nuevas funciones o que se lleven a cabo por motivos legales, le informaremos con 30 días de antelación de cualquier cambio que entre en vigor respecto a estos Términos y que afecte a los derechos u obligaciones de alguna de las partes en estos Términos, por ejemplo a través de una notificación de servicio o de un correo electrónico a la dirección de correo electrónico asociada a su cuenta. Al continuar accediendo o utilizando los Servicios después de que dichos cambios se hagan efectivos, usted acepta estar sujeto a los Términos revisados.<br><br>

                    En caso de que cualquier disposición de estos Términos se considere inválida o no pueda entrar en vigor, entonces, dicha disposición se verá limitada o eliminada en la menor medida necesaria, y las restantes disposiciones de estos Términos seguirán en vigor y mantendrán su pleno efecto. El hecho de que Twitter no obligue al cumplimiento de alguno de los derechos o disposiciones de estos Términos no se considerará una omisión de dicho derecho o disposición.<br><br>
                    
                    Estas Condiciones son un acuerdo entre usted y Twitter International Company, una empresa irlandesa con domicilio social en One Cumberland Place, Fenian Street Dublin 2, D02 AX07, Irlanda. Si tiene alguna duda sobre estas condiciones, contacte con nosotros.
                </p>
                <p><b>Efectividad:</b> 25 de mayo de 2018</p>
                <a href="#">Archivo de términos anteriores</a>
             </div> 
          </div>
      </div>
      <footer>
          <div class="footer-item"><a>© 2018 Twitter, Inc.</a></div>
          <div class="footer-item"><a href="cookies.html">Cookies</a></div>
          <div class="footer-item"><a href="">Privacidad</a></div>
          <div class="footer-item"><a href="">Terminos y condiciones</a></div>
          <div class="footer-item"><a href="">Español</a></div>
