        ...
        <div class="col-sm-7 col-md-7 col-lg-6  col-xl-6 col-central">
            <div class="row">
                ...
                <div class="contenedor2">
                    <div style="float:left" id="textoSup"><b>Busqueda</b></div>
            ...
            <a id="link-follower"><img class="inline rounded-circle follower-img-perfil" src="'.$_SESSION["busquedaImgU"].'" id="img-follower">
                <p class="inline" id="name-follower"><b>'.$_SESSION["busqueda"]["nombre"].'</b></p>
                <p class="inline" id="user-follower">@'.$_SESSION["busqueda"]["usuario"].'</p> 
                <br> 
            </a>
            </div>
            </div>
